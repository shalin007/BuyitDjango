    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('shipping_total', models.DecimalField(decimal_places=2, default=5.99, max_digits=50, max_length=150)),
                ('total', models.DecimalField(decimal_places=2, default=5.99, max_digits=50, max_length=150)),
